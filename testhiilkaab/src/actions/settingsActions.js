...
export const createSettings = ( phoneNumber,whatsAppPhoneNumber, about, aboutImg ) => async (
  dispatch,
  getState
) => {
  try {
    ...
    const config = {
      ...
      const { data } = await axios.post(`/api/settings`, { phoneNumber, whatsAppPhoneNumber, about, aboutImg }, config)
